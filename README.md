...
Just like with most other autoclickers, the start/end keys can be *any* key (including mouse buttons), and you can start the autoclicker in another window (but not another desktop).  
